...
declare class PinAPI {
    ...
    addAll: (source: import("ipfs-core-types").AwaitIterable<import("ipfs-core-types/src/pin").AddInput>, options?: any) => AsyncIterable<import("multiformats").CID>;
    add: (path: string | import("multiformats").CID, options?: any) => Promise<import("multiformats").CID>;
    rmAll: (source: import("ipfs-core-types").AwaitIterable<import("ipfs-core-types/src/pin").RmAllInput>, _options?: any) => AsyncIterable<import("multiformats").CID>;
